...
import { getSupplierIntegrations, importSupplierProduct, searchSupplierCatalog } from "../controllers/supplierIntegrationController";
...
apiRouter.post("/suppliers/catalog/import", importSupplierProduct);
