  ...
  res.json({
    sources: [
      ...
      },
      {
        ...
        status: account ? "READY" : "AUTH_REQUIRED",
        dataType: "REAL",
        purpose: "Identificar productos de catálogo, buy-box winner, precio actual y sold_quantity disponible",
      },
      {
      ...
      },
      {
        ...
        purpose: "Encontrar proveedores candidatos. Los resultados son leads; precios y cotizaciones deben verificarse antes de invertir.",
      },
    ],
